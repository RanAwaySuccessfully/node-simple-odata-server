...
Node.prototype.transform = function () {
  ...
  if (this.right?.value instanceof Date && !isNaN(this.right?.value)) {
    this.right.value = this.right.value.toISOString();
  }
  ...
  if (this.type === 'and') {
    ...
    result.$and.push(new Node(this.left.type, this.left.left, this.left.right, this.func || this.left.func, this.args || this.left.args).transform())
    result.$and.push(new Node(this.right.type, this.right.left, this.right.right, this.func || this.right.func, this.args || this.right.args).transform())
  }

  if (this.type === 'or') {
    result.$or = result.$or || []
    result.$or.push(new Node(this.left.type, this.left.left, this.left.right, this.func || this.left.func, this.args || this.left.args).transform())
    result.$or.push(new Node(this.right.type, this.right.left, this.right.right, this.func || this.right.func, this.args || this.right.args).transform())
  }
